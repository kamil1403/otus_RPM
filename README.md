<p align="center">
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Red_Hat_logo.svg/800px-Red_Hat_logo.svg.png" alt="Red Hat Banner" width="30%">
</p>
...
### ✅ Результат
- [x] RPM-пакет `otus-package-1.0-1` собран вручную. Результат см. на скриншоте 🖼️ ["otus_rpm_1.png"](https://github.com/kamil1403/otus_RPM/blob/main/screenshots/otus_rpm_1.png)
- [x] Локальный репозиторий создан
- [x] Пакет доступен для скачивания через Nginx. Результат см. на скриншоте 🖼️ ["otus_rpm_2.png"](https://github.com/kamil1403/otus_RPM/blob/main/screenshots/otus_rpm_2.png)
