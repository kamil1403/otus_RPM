...
### ✅ Результат
- [x] RPM-пакет `otus-package-1.0-1` собран вручную. Результат см. на скриншоте 🖼️ ["otus_rpm_1.png"](repo_check.png)
- [x] Локальный репозиторий создан
- [x] Пакет доступен для скачивания через Nginx. Результат см. на скриншоте 🖼️ ["otus_rpm_2.png"](repo_check.png)
